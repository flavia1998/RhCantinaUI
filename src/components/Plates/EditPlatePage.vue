    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <form @submit.prevent="updatePlate">
              <div class="mb-3">
              ...
              <div v-if="plate.image" class="d-flex justify-content-center mb-3">
                <img :src="plate.image" alt="Imagem do prato" class="img-fluid mt-3" />
              </div>
  ...
  methods: {
    ...
    async updatePlate() {
      ...
      try {
        ...
        this.errorMessage = error.message || 'Erro a atualizar prato';
      }
    }
  }
};
